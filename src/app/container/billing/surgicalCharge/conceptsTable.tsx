...
const ConceptsTable = ({
  ...
  const columns: ColumnsType<TTariffDetail> = [
    { title: "Código alterno", dataIndex: "referenceCode", width: 130 },
    ...
    { title: "Tarifario", dataIndex: "tariffName", width: 160, render: (v?: string) => v ?? "-" },
    { title: "Unidad", dataIndex: "factors", width: 100, render: (v: number) => formatFactor(v) },
    { title: "Valor", dataIndex: "value", width: 130, render: (v: number) => formatCurrency(v) },
  ]
  ...
  return (
    ...
    >
      ...
      <Table<TTariffDetail>
        ...
        pagination={false}
        scroll={{ x: 720 }}
        locale={{ emptyText: <Empty description="No hay conceptos para esta cirugía" /> }}
      />
