...
export const AnalysisTab = ({ value, onChange, disabled }: Props) => (
  <div className="tab-section-inner">
    <Typography.Title level={5} style={{ marginTop: 0 }}>3. Análisis <span className="field-required">*</span></Typography.Title>
