...
export interface ProcedimientoMenorViewData {
...
interface Props {
  data: ProcedimientoMenorViewData
  professionalIsReference?: boolean
}

export const ProcedimientoMenorDetailView = ({ data, professionalIsReference }: Props) => (
  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
    ...
    <div>
      <Typography.Text strong>Procedimiento menor</Typography.Text>
